/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 28dba09c4e252cc69d53515e30c1221e)
// Runtime types generated with workerd@1.20260430.1 2026-05-01 nodejs_compat
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "PushSubscriptionStore" | "PushMCP";
	}
	interface Env {
		VAPID_PUBLIC_KEY: string;
		VAPID_PRIVATE_KEY: string;
		VAPID_SUBJECT: string;
		PUSH_STORE: DurableObjectNamespace<import("./src/index").PushSubscriptionStore>;
		MCP_OBJECT: DurableObjectNamespace<import("./src/index").PushMCP>;
	}
}
